...
class FlowLayout_45655143 extends Base {
  ...
  register() {
    ...
    DataManipulationHelper.register("66766b99", "insert", ["03168663","18091a36","382a7358","53063929","5a318376"], {initClass: null, submitCrossType: null, enabledRealTimeUpdate: false, manipulateInto: () => { return eval("\"Post\""); }});
  }
  // <---Auto[ClassBegin]
          ...
          .col-9.internal-fsb-element.internal-fsb-strict-layout(style={'paddingLeft': '30px', 'paddingRight': '30px', 'paddingTop': '15px'}, internal-fsb-class="FlowLayout", internal-fsb-guid="c6060bb4")
            .internal-fsb-element.internal-fsb-strict-layout(style={'marginBottom': '15px', 'paddingLeft': '0px', 'paddingRight': '0px', 'position': 'sticky', 'top': '0px', 'zIndex': '1000'}, internal-fsb-class="FlowLayout", internal-fsb-guid="3ae1734a")
              .col-12.internal-fsb-element.offset-0(style={padding: '0px'}, internal-fsb-forward="1", internal-fsb-guid="53063929")
                textarea.form-control.form-control-sm(style={'display': 'block', 'width': '100%'}, onKeyPress=this.onTextboxKeyPress_53063929.bind(this), placeholder="คุณต้องการบอกอะไรกับชาวโลก?", rows="2", type="text")
              input.col-12.internal-fsb-element(type="hidden", internal-fsb-guid="18091a36")
              input.col-12.internal-fsb-element(type="hidden", internal-fsb-guid="5a318376")
              input.col-12.internal-fsb-element(type="hidden", internal-fsb-guid="382a7358")
              input.col-12.internal-fsb-element(type="hidden", internal-fsb-guid="03168663")
              Button.btn.btn-secondary.btn-sm.col-2.internal-fsb-element(style={'display': 'none'}, ref="submit", onClick=((event) => { window.internalFsbSubmit('66766b99', 'Post', event, ((results) => { this.manipulate('66766b99', 'Post', results); }).bind(this)); }).bind(this), type="button", internal-fsb-guid="66766b99")
            ...
            .internal-fsb-element.internal-fsb-strict-layout(style={'paddingLeft': '0px', 'paddingRight': '0px'}, internal-fsb-class="FlowLayout", internal-fsb-guid="ac036c3a")
              each data, i in this.getDataFromNotation("Post", true, false)
                .internal-fsb-element.internal-fsb-strict-layout(style={'paddingLeft': '0px', 'paddingRight': '0px'}, key="item_" + (data && data.keys && Object.keys(data.keys).map((key)=>{return key + ":" + data.keys[key];}).join("_") || i), data-fsb-index=i, internal-fsb-class="FlowLayout", internal-fsb-guid="166e6ba0")
                  ...
                  .internal-fsb-element.internal-fsb-stretch.internal-fsb-strict-layout(style={'WebkitAlignContent': 'space-between', 'WebkitFlexBasis': '0px', 'WebkitFlexGrow': '1', 'alignContent': 'space-between', 'flexBasis': '0px', 'flexGrow': '1', 'paddingLeft': '0px', 'paddingRight': '0px'}, internal-fsb-class="FlowLayout", internal-fsb-guid="247b6c15")
                    ...
                    .col-12.internal-fsb-element(style={'fontSize': '13px', 'paddingRight': '0px', 'textAlign': 'right'}, internal-fsb-guid="29674a6c")
